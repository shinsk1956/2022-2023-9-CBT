...
const StatsModal: React.FC<StatsModalProps> = ({ data, onClose, examRecordId, onStartDojo }) => {
  const stats = useMemo(() => {
    const dataSource = examRecordId ? data.filter(f => f.id === examRecordId) : data;
